    ...
    <>
      <form className='m-auto my-16 max-w-[500px] bg-white p-8 border-2 shadow-md rounded-md'>
        {loading ? (
          ...
          <>
            <h2 className='text-center mb-4'>Welcome back! Log in to your account.</h2>
            <div className="mb-4">
            ...
            <div className="mb-4 flex justify-center">
              <button className='bg-yellow-500 text-white px-4 py-2 rounded-sm font-medium hover:bg-yellow-600' onClick={handleSubmit}>Login</button>
            </div>

            <div className='pt-4'>
              <Link to="/signup" className='text-yellow-400'>Don't have an account? Signup here</Link>
            </div>
          </>
        )}
      </form>
