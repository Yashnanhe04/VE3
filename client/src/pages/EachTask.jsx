            ...
            <>
              ...
              <div className="flex justify-center">
                <Link
                  ...
                  className="bg-yellow-500 text-white px-4 py-2 font-medium hover:bg-yellow-600 rounded-lg mr-4"
                >
                  Edit Task
                </Link>
                <Link to="/" className="bg-yellow-500 text-white px-4 py-2 font-medium hover:bg-yellow-600 rounded-lg">
                  Go Back
                </Link>
              </div>
            </>
