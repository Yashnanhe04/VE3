    ...
    <>
      <form className='m-auto my-16 max-w-[500px] p-8 bg-white border-2 shadow-md rounded-md'>
        {loading ? (
          ...
          <>
            <h2 className='text-center mb-4 text-lg'>Welcome to our community! Sign up now.</h2>
            <div className="mb-4">
            ...
            <div className="mb-4 flex justify-center">
              <button className='bg-yellow-500 text-white px-4 py-2 rounded-sm font-medium hover:bg-yellow-600' onClick={handleSubmit}>SignUp</button>
            </div>

            <div className='pt-4'>
              <Link to="/login" className='text-yellow-400'>Already have an account? Login here</Link>
            </div>
          </>
        )}
