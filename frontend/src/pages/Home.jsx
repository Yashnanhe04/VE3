        ...
        {!isLoggedIn ? (
          ...
          <div className='mt-8'>
            ...
            <div className='flex items-center justify-center mt-8'>
              <Link to='/tasks' className='block px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg mr-5'> <i className="fa-solid fa-tachometer "></i> Dashboard </Link>
              <Link to='/tasks/add' className='block px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg mr-5'> <i className="fa-solid fa-plus"></i> Create Task </Link>
            </div>
          </div>
        )}
      </MainLayout>
